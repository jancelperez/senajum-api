...
(0, _ava2.default)('invalid token POST /', async t => {
  ...
  await t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/xampp/htdocs/SENAJUM/senagram-api/test/pictures-test.js', 83), _avaThrowsHelperEnd(t, (0, _requestPromise2.default)(options))), /invalid token/);
  console.log(token);
});
// POST / es la segunda ruta la cual es un test asincrono
...
//# sourceMappingURL=..\node_modules\.cache\ava\2ff432f5c0669fe2e49988b923f34a78.js.map