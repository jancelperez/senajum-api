...
(0, _ava2.default)('GET /:id', async t => {
  ...
  let body = await (0, _requestPromise2.default)({ url: `${url}/${id}`, json: true });
  console.log(`${body} este es body`);
...
//# sourceMappingURL=..\node_modules\.cache\ava\c46f04cc18634b948228fb664e919035.js.map