...
_ava2.default.beforeEach(async t => {
  ...
  t.context.url = (0, _testListen2.default)(servidor);
});
...
(0, _ava2.default)('GET /:id', async t => {
  ...
  let url = await t.context.url;
  console.log(`${url} esto es una prueba`);
...
//# sourceMappingURL=..\node_modules\.cache\ava\f66bf917a9692347c60172efee59e0a7.js.map