...
(0, _ava2.default)('no token POST /', async t => {
  ...
  };t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/xampp/htdocs/SENAJUM/senagram-api/test/pictures-test.js', 65), _avaThrowsHelperEnd(t, (0, _requestPromise2.default)(options))), /invalid token/);
});
...
(0, _ava2.default)('secure POST /', async t => {
  ...
  let options = {
    ...
    // let response = await request(options).body

    // t.is(response.statusCode, 201)
  };t.deepEqual((0, _requestPromise2.default)(options).body, imagen);
});
...
//# sourceMappingURL=..\node_modules\.cache\ava\60e7ba036f610fc77c04b18acae04ec8.js.map