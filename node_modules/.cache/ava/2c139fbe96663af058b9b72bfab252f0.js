...
(0, _ava2.default)('GET /: ID', async t => {
  ...
  let servidor = (0, _micro2.default)(async (req, res) => {
  ...
  let body = await (0, _requestPromise2.default)({ url: url, json: true });
...
//# sourceMappingURL=..\node_modules\.cache\ava\2c139fbe96663af058b9b72bfab252f0.js.map