...
(0, _ava2.default)('no token POST /', async t => {
  ...
  await t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/xampp/htdocs/SENAJUM/senagram-api/test/pictures-test.js', 62), _avaThrowsHelperEnd(t, (0, _requestPromise2.default)(options))), /invalid token/);
});

// si hay un ataque malicioso hacky en el toquen
(0, _ava2.default)('invalid token POST /', async t => {
  let imagen = _fixtures2.default.getImagen();
  let url = t.context.url;
  let token = await _utils2.default.iniciarToken({ userId: 'hacky' }, _config2.default.secret);
  ...
  await t.throws((_avaThrowsHelperStart(t, 'throws', 'C:/xampp/htdocs/SENAJUM/senagram-api/test/pictures-test.js', 85), _avaThrowsHelperEnd(t, (0, _requestPromise2.default)(options))), /invalid token/);
});
// POST / es la segunda ruta la cual es un test asincrono
(0, _ava2.default)('secure token POST /', async t => {
  let imagen = _fixtures2.default.getImagen();
  let url = t.context.url;
...
//# sourceMappingURL=..\node_modules\.cache\ava\5d5b8f3431716ded99c0be288121d2b7.js.map