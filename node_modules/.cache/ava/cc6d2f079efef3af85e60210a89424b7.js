...
var _senagramDb = require('senagram-db');

var _senagramDb2 = _interopRequireDefault(_senagramDb);
...
(0, _ava2.default)('POST /', async t => {
  let user = _senagramDb2.default.getUsuario();
...
(0, _ava2.default)('GET /:username', async t => {
  let user = _senagramDb2.default.getUsuario();
  let url = t.context.url;
...
//# sourceMappingURL=..\node_modules\.cache\ava\cc6d2f079efef3af85e60210a89424b7.js.map