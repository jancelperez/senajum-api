...
(0, _ava2.default)('no token POST /', async t => {
  ...
  let response = (0, _requestPromise2.default)(options);
...
(0, _ava2.default)('secure POST /', async t => {
  ...
  let response = await (0, _requestPromise2.default)(options).body;
...
//# sourceMappingURL=..\node_modules\.cache\ava\53e2a695404ee1c85aaa706f99f9bc65.js.map